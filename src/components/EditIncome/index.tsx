...
import { NEURALWEB_PREF_ADDEXPENSE_ANOTHER } from '../../constants/SessionStorageConstants';
...
const EditIncome = (props: Props) => {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem(NEURALWEB_PREF_ADDEXPENSE_ANOTHER)) {
      setAddAnother(
        sessionStorage.getItem(NEURALWEB_PREF_ADDEXPENSE_ANOTHER) === 'true'
      );
    }
  }, []);
  ...
  const toggleAddAnother = () => {
    sessionStorage.setItem(
      NEURALWEB_PREF_ADDEXPENSE_ANOTHER,
      (!addAnother).toString()
    );
