...
export const LABEL_ITEMS_UPDATE = 'LABEL_ITEMS_UPDATE';
export const LABEL_ITEMS_APPEND = 'LABEL_ITEMS_APPEND';
export const LABEL_ITEMS_DELETE = 'LABEL_ITEMS_DELETE';
