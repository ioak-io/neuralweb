...
export const FOLDER_ITEMS_FETCH_AND_SET = 'FOLDER_ITEMS_FETCH_AND_SET';
export const FOLDER_ITEMS_UPDATE = 'FOLDER_ITEMS_UPDATE';
export const FOLDER_ITEMS_APPEND = 'FOLDER_ITEMS_APPEND';
export const FOLDER_ITEMS_DELETE = 'FOLDER_ITEMS_DELETE';
...
export const TAG_ITEMS_FETCH_AND_SET = 'TAG_ITEMS_FETCH_AND_SET';
